...
export default function DailiForm({ route }) {
  ...
  const karaokeOption1 = () => {
    ...
    navigation.navigate("InfoPage11", { inputText: user_name });
  ...
  const karaokeOption2 = () => {
    ...
    navigation.navigate("InfoPage22", { inputText: user_name });
  };
          ...
          {showForm2 && (
            <View style={styles.formContainer}>
              ...
              <TouchableOpacity
                ...
                onPress={karaokeOption2}
              >
                <Text style={styles.dropdownText}>Massage</Text>
                <Image
                  style={{
                    width: "100%",
                    height: 100,
